...
NormalView.prototype.init = function(context, evtListener)
{
...
NormalView.prototype.onInitDone = function()
{
...
NormalView.prototype.onActiveDone = function(isFirst)
{
...
NormalView.prototype.onGetDataBtnClick = function(comp, info, e)
{
	var data = this.getView1.getData();
	this.getTxa1.setText(JSON.stringify(data));
};

NormalView.prototype.onGetDataBtn2Click = function(comp, info, e)
{
	var data = this.getView2.getData();
	this.getTxa2.setText(JSON.stringify(data));
};

NormalView.prototype.onSetDataBtnClick = function(comp, info, e)
{
	this.grid.removeAll();
...
NormalView.prototype.onSetDataBtn2Click = function(comp, info, e)
{
